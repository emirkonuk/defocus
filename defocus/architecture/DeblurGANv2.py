# AUTOGENERATED! DO NOT EDIT! File to edit: nbs/08_architecture_DeblurGANv2.ipynb (unless otherwise specified).

__all__ = ['Discriminator', 'Generator', 'FPNHead', 'FPN', 'instance_norm']
